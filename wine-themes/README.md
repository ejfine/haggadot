...
If you want to quickly scan the text of those readings (rather than looking at them in the context of the full Haggadah PDF), you can view the files in this folder.
...
To me, these readings seemed like an apolitical celebration of human progress. But at one Seder where I used this theme, some right-leaning participants became upset that this seemed like leftist propaganda, while other left-leaning participants at the exact same Seder accused it of being right-wing delusions. Of all the themes included, this is the only one that has ever had that sort of reception (and only at that one particular Seder---at many Seders using this theme all the participants enjoyed the readings and discussions), but just as an FYI in case you think your guests might be particularly prone to taking offense.